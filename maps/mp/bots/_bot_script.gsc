...
bot_script_init()
{
	level thread maps\mp\bots\objectives\_manager::init();
}
...
connected()
{
	...
	self thread maps\mp\bots\objectives\_manager::connected();
}
...
onSpawned()
{
	...
	for ( ;; )
	{
		...
		self thread maps\mp\bots\objectives\_manager::spawned();
	}
}
